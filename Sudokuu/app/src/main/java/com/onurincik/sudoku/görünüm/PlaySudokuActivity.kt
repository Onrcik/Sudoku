package com.onurincik.sudoku.görünüm
...
import com.onurincik.sudoku.R
import com.onurincik.sudoku.Oyun.Hücre
import com.onurincik.sudoku.görünüm.custom.SudokuBoardView
import com.onurincik.sudoku.modeligörüntüleme.PlaySudokuViewModel
import kotlinx.android.synthetic.main.activity_play_sudoku.*

class PlaySudokuActivity : AppCompatActivity(), SudokuBoardView.OnTouchListener {

    private lateinit var viewModel: PlaySudokuViewModel
    private lateinit var sayıButtonları: List<Button>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sayıButtonları = listOf(oneButton, twoButton, threeButton, fourButton, fiveButton, sixButton,
                sevenButton, eightButton, nineButton)

        sayıButtonları.forEachIndexed { index, button ->
    ...
    private fun updateCells(hücres: List<Hücre>?) = hücres?.let {
        sudokuBoardView.updateCells(hücres)
    }
